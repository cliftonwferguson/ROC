...
public class PrimativeTypes {
	 ...
	 * 
	 * In Java, we can specify two types of 
	 * variables. Primitives and References. 
	 */
  byte b = 127; //whole number 8 bits
  short s = 12345; //whole number that is 16 bits
  int i = 1_000_000; //whole number 32 bits
  long l = 1_000_000_000l;  //whole number 64 bits, uses lowercase letter 'L' to denote long
